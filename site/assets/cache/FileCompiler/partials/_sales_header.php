...
<?php else: ?>
	<header id="top-head" class="uk-width-1-1 uk-position-fixed uk-background-white" data-id="<?php echo $user->product; ?>">
		<div class="uk-container uk-container-large">
			<nav class="uk-navbar uk-dark" data-uk-navbar="mode:click; duration: 250">
				...
				<div class="uk-navbar-right">
					<form class="uk-search uk-search-default uk-grid uk-grid-collapse uk-margin-small-right" method="get" action="<?=$root?>sales-portal/search/" style="min-width: 450px;padding:3px">
				        <div class="uk-width-expand uk-position-relative uk-margin-small-right">
					        ...
					        <div class="uk-position-center-right">
					        	<select name="p" class="uk-select" style="width: 90px;border: none; height: 30px;margin-right: 5px;font-size: 13px;background-color: #f6f6f6">
						        	<option>Product</option>
						        	<option value="1">Personal Loan</option>
						        	<option value="2">Credit Card</option>
						        	<option value="3">NRI</option>
						        	<option value="4">Business Banking</option>
						        </select>
						        <select name="c" class="uk-select" style="width: 90px;border: none; height: 30px;margin-right: 5px;font-size: 13px;background-color: #f6f6f6">
					...
					<ul class="uk-navbar-nav">
						<li><a href="<?=$root?>profile/" title="Your profile" data-uk-tooltip><span class="uk-margin-small-right" data-uk-icon="icon:user"></span> Profile</a></li>
						<!-- <li><a href="#" data-uk-icon="icon: settings" title="Settings" data-uk-tooltip></a></li> -->
						<li><a href="<?=$root?>logout/" title="Sign Out" data-uk-tooltip><span class="uk-margin-small-right" data-uk-icon="icon:sign-out"></span> Sign Out</a></li>
