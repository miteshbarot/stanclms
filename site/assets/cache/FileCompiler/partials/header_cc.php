	...
	<div class="uk-container uk-container-large">
		<nav class="uk-navbar-container p-logo uk-navbar-transparent" uk-navbar>
		    ...
		    <div class="uk-navbar-right">
		        <h1 class="uk-margin-remove fs-22 fs-16-mobile ff-helvetica-bold uk-primary uk-text-right hidden_on_mobile"><span class="ff-helvetica header-txt1">You are applying for</span>
				<br><?=$card->title?></h1>
