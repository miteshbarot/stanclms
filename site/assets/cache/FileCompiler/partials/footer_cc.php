...
<div class="uk-margin-medium-top uk-tnccontainer cc-container tnc-hlolder">
	<h2 class="ff-helvetica-bold fs-20 uk-text-center uk-margin-medium-bottom uk-text-white">Terms & Conditions</h2>
		<div class="uk-margin-medium-top">
			<div class="uk-grid-small uk-grid-match uk-child-width-1-3@m uk-child-width-1-1@s uk-child-width-1-1 uk-flex-center" uk-grid>


					<?php if($id != "" && $checkCard->fname != "" || $checkCard->link!=""){ ?>
					<?php if($checkCard->fname!=""){ ?>
					<div class="cc_child_ht_match">
						<div class="uk-border-rounded uk-position-relative uk-padding-small uk-text-center">
					...
					<div class="cc_child_ht_match">
						<div class="uk-border-rounded uk-position-relative uk-padding-small uk-text-center">
							...
							<div class="uk-display-block fs-15">
								...
								<a href="https://av.sc.com/in/content/docs/in-credit-card-terms-and-condition.pdf" title="ECS form" target="_blank"><u>Read More</u></a>
							</div>
						</div>
					</div>
				</div>
...
<?php include(\ProcessWire\wire('files')->compile('partials/_form_handling.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)))?>
