...
ini_set('max_execution_time', 0);
 include(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . "site/templates/LeadAPI.php",array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
...
function getmasterPincodes($ptype){
 ...
 if($ptype=="CC"){
    ...
    $result = \ProcessWire\wire('db')->query($sql1); 
    $i=0;
