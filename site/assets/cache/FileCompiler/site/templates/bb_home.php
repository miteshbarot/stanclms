<?php include(\ProcessWire\wire('files')->compile("partials/header_bb.php",array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));?>
...
<?php 
 include(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . 'site/templates/_form_handling.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true))); 
/*
idle popup to be enabled after chat & request callback is implemented
 ...
 include(\ProcessWire\wire('files')->compile("partials/footer_bb.php",array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
?>