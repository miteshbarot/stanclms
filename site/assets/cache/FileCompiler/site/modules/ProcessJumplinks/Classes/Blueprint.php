...
class Blueprint
{
  ...
  protected function findBlueprint($file)
  {
    ...
    if (file_exists('/var/www/html/site/modules/ProcessJumplinks/Classes' . $file)) {
      return file_get_contents('/var/www/html/site/modules/ProcessJumplinks/Classes' . $file);
    }

    foreach ($extensions as $extension) {
      $withExt = "{$file}.{$extension}";
      if (file_exists('/var/www/html/site/modules/ProcessJumplinks/Classes' . $withExt)) {
        return file_get_contents('/var/www/html/site/modules/ProcessJumplinks/Classes' . $withExt);
      }
    }

    throw new Exception('Blueprint not found: ' . '/var/www/html/site/modules/ProcessJumplinks/Classes' . $file);
  }
