		...
		<div class="uk-width-1-2">
			<table class="uk-table uk-table-divider uk-table-border uk-table-striped uk-table-hover">
				...
				<tr>
					...
					<td class="">&nbsp;<?=$p->product_of_interest?></td>
				</tr>
				<!-- <tr>
				...
				<tr>
					<td class="uk-text-right uk-text-blue">Nature of Business</td>
					<td><?=$p->business_type?></td>
				</tr>
				<tr>
					<td class="uk-text-right uk-text-blue">Turnover</td>
					<td><?=$p->turnover?></td>
				</tr>
				<tr>
					<td class="uk-text-right uk-text-blue">Business Start Date</td>
					<td><?=$p->start_mm." ".$p->start_year?></td>
				</tr>
				<tr>
					...
					<div class="uk-width-1-1">
						...
						<form action="<?=$page->url.$input->urlSegment1?>?view=iframe" method="post" id="status_1" class="uk-margin stat_update_form uk-grid uk-grid-small" style="display: none">
							...
							<div class="uk-margin-small uk-width-1-2">
								<select id="app_status_process_bb" class="uk-select" name="app_status_process" tabindex="1" required>
						...
						<form action="<?=$page->url.$input->urlSegment1?>?view=iframe" method="post" id="status_3" class="uk-margin stat_update_form uk-grid uk-grid-small" style="display: none">
							<div class="uk-margin-small uk-margin-remove-top uk-width-1-2">
								<select id="success_select" class="uk-select" name="code" tabindex="1" required>
									<option>Select Success Status</option>
							...
							<div class="uk-margin-small uk-width-1-2">
								...
								<input type="text" class="uk-input" tabindex="2" placeholder="Client ID" name="app_status_client_id" required minlength="12" maxlength="18" autofocus />
							</div>
							<div class="uk-margin-small uk-margin-remove-top uk-width-1-2">
								<input type="text" id="fromDate" class="uk-input" tabindex="3" placeholder="Date of account opening" name="app_status_date" required/>
							</div>
							<!-- <div class="uk-margin-small uk-width-1-2">
