...
function validatePincode(pin,ptype){
 // console.log('in p fun');
   ...
   // var mob =$('#'+mobval).val();
    var data = "pincode="+pin+"&post_type=pin&p="+ptype;
      $.ajax({
        ...
        success:function(response){
          ...
          if(response.status=="2"){
            alert("Thank you for your interest in a Standard Chartered Credit Card. We regret to inform you, that we are unable to proceed with your application as it doesnot meet the prescribed policy requirements.");
